...
<div class="topnav">
    ...
    <a href="<?php print htmlspecialchars($URI."?prefix=ae_reporting&page=pages/FDAAELog.php"."&pid=".$project_id)?>" style=" background-color: #ffffff; color: #C05D4F; border-bottom: 6px solid #C05D4F;">FDA AE Log</a>
    <?php if ($warning){
...
//$ct_fields_b = array('num_of_events', 'num_of_subj_affected', 'num_of_subj_at_risk');
...
$(document).ready(function() {
    $(document).on('click','#button_03_s',function(){
        document.location.href = '/..<?php print htmlspecialchars($URI)?>?prefix=ae_reporting&page=pages/output_stream_fda_csv.php&pid=<?php echo htmlspecialchars($project_id)?>&aet=s';
    } );
} );
</script>
...
<script>
    $(document).ready(function() {
        $(document).on('click','#button_03_o',function(){
            document.location.href = '/..<?php print htmlspecialchars($URI)?>?prefix=ae_reporting&page=pages/output_stream_fda_csv.php&pid=<?php echo htmlspecialchars($project_id)?>&aet=o';
        } );
    } );
</script>
...
<script>
    $(document).ready(function() {
        $(document).on('click','#button_04_s',function(){
            document.location.href = '/..<?php print htmlspecialchars($URI)?>?prefix=ae_reporting&page=pages/output_stream_fda_txt.php&pid=<?php echo htmlspecialchars($project_id)?>&aet=s';
        } );
    } );
</script>
...
<script>
    $(document).ready(function() {
        $(document).on('click','#button_04_o',function(){
            document.location.href = '/..<?php print htmlspecialchars($URI)?>?prefix=ae_reporting&page=pages/output_stream_fda_txt.php&pid=<?php echo htmlspecialchars($project_id)?>&aet=o';
        } );
    } );
</script>